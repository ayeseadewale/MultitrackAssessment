                    ...
                    <nav class="discovery--nav">
                        <ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
                            ...
                            <li class="discovery--nav--list--item tab-filter--item">
                                <a class="tab-filter" href="<%# "../PageToSync/artists/songs.aspx?id="+Eval("artistID")%>">Songs</a>
                            </li>
                            <li class="discovery--nav--list--item tab-filter--item">
                                <a class="tab-filter" href="<%# "../PageToSync/artists/albums.aspx?id="+Eval("artistID")%>">Albums</a>
                            </li>
                        </ul>
                        ...
                        <main class="discovery--section">
                            ...
                            <section class="standard--holder">
                                <div class="discovery--section--header">
                                    <h2>Top Songs</h2>
                                    <a class="discovery--section--header--view-all" href="<%# "../PageToSync/artist/songs/details.aspx?id="+Eval("artistID")%>">View All</a>
                                </div>
                                <!-- /.discovery-select -->
                            ...
                            <div class="discovery--space-saver">
                                <section class="standard--holder">
                                    <div class="discovery--section--header">
                                        <h2>Albums</h2>
                                        <a class="discovery--section--header--view-all" href="<%# "../PageToSync/artist/albums/details.aspx?id="+Eval("artistID")%>">View All</a>
                                    </div>
                                    <!-- /.discovery-select -->
                            ...
                            <section class="standard--holder">
                                ...
                                <div class="artist-details--biography biography">
                                    <p id="partial-bio">
                                        <%# new String(Eval("artistBio").ToString().Take(500).ToArray()) + "..." %>
                                    </p>
